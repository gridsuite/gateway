...
public class FilterServer implements EndPointServer {

    public static final String ENDPOINT_NAME = "filter";

    private final ServiceURIsConfig servicesURIsConfig;

    public FilterServer(ServiceURIsConfig servicesURIsConfig) {
        this.servicesURIsConfig = servicesURIsConfig;
    }

    @Override
    public String getEndpointBaseUri() {
        return servicesURIsConfig.getFilterServerBaseUri();
    }
