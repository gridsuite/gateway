...
public class ElementAccessControlTest {
    ...
    public void prepareToken() throws JOSEException {
        ...
        SignedJWT signedJWT1 = new SignedJWT(new JWSHeader.Builder(JWSAlgorithm.RS256).keyID(rsaJWK.getKeyID()).build(),
                claimsSet1);
        SignedJWT signedJWT2 = new SignedJWT(new JWSHeader.Builder(JWSAlgorithm.RS256).keyID(rsaJWK.getKeyID()).build(),
                claimsSet2);
    ...
    public void testWithNoControl() {
        ...
        stubFor(get(urlEqualTo("/v1/svg-component-libraries")).withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
        stubFor(get(urlEqualTo("/v1/export-network-formats")).withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
        stubFor(get(urlEqualTo("/v1/loadflow-default-provider")).withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
        webClient
    ...
    public void testGetElements() {
        ...
        // user1 allowed
        stubFor(head(urlEqualTo(String.format("/v1/elements?ids=%s", uuid))).withPort(port)
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));

        // user2 not allowed
        stubFor(head(urlEqualTo(String.format("/v1/elements?ids=%s", uuid))).withPort(port)
                .withHeader("userId", equalTo("user2"))
        ...
        stubFor(get(urlEqualTo(String.format("/v1/studies/metadata?ids=%s", uuid)))
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
    ...
    public void testCreateElements() {
        ...
        // user1 allowed
        stubFor(head(urlEqualTo(String.format("/v1/directories?ids=%s", uuid))).withPort(port)
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
        stubFor(head(urlEqualTo(String.format("/v1/elements?ids=%s", uuid))).withPort(port)
                .withHeader("userId", equalTo("user1"))
        ...
        stubFor(post(urlEqualTo(String.format("/v1/explore/studies/%s?%s=%s", "study1",
                ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid))).withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));

        stubFor(post(urlEqualTo(String.format("/v1/explore/script-contingency-lists/%s?%s=%s", "scl1",
                ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid))).withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));

        stubFor(post(urlEqualTo(String.format("/v1/explore/filters/%s?%s=%s", "filter1",
                ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid))).withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));

        // Direct creation of elements without going through the explor server is
        // forbidden
        webClient
        ...
        // Creation of elements with bad parameter for directory parent uuid is
        // forbidden
        webClient
                .post()
                .uri(String.format("explore/v1/explore/studies/%s?%s=%s", "study1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID + "bad", uuid))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isForbidden();
        ...
        webClient
                .post()
                .uri(String.format("explore/v1/explore/studies/%s?%s=%s", "study1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, "badUuid"))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isForbidden();
        webClient
                .post()
                .uri(String.format("explore/v1/explore/studies/%s?%s=%s", "study1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, null))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isForbidden();
        ...
        webClient
                .post()
                .uri(String.format("explore/v1/explore/studies/%s?%s=%s,%s", "study1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid, uuid))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isForbidden();
        ...
        webClient
                .post()
                .uri(String.format("explore/v1/explore/studies/%s?%s=%s", "study1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isOk();
        ...
        webClient
                .post()
                .uri(String.format("explore/v1/explore/script-contingency-lists/%s?%s=%s", "scl1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isOk();
        ...
        webClient
                .post()
                .uri(String.format("explore/v1/explore/filters/%s?%s=%s", "filter1",
                        ExploreServer.QUERY_PARAM_PARENT_DIRECTORY_ID, uuid))
                .header("Authorization", "Bearer " + tokenUser1)
                .exchange()
                .expectStatus().isOk();
    ...
    public void testCreateSubElements() {
        ...
        stubFor(post(urlEqualTo(String.format("/v1/studies/%s/tree/nodes", uuid)))
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
    ...
    public void testUpdateElements() {
        ...
        stubFor(put(urlEqualTo(String.format("/v1/studies/%s/nodes/idNode", uuid)))
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));

        stubFor(put(urlEqualTo(String.format("/v1/script-contingency-lists/%s", uuid)))
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
    ...
    public void testDeleteElements() {
        ...
        stubFor(delete(urlEqualTo(String.format("/v1/explore/elements/%s", uuid)))
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
        ...
        stubFor(delete(urlEqualTo(String.format("/v1/contingency-lists/%s", uuid)))
                .withHeader("userId", equalTo("user1"))
                .willReturn(aResponse()));
